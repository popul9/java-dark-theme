# Java Dark Theme
![Screenshot](https://github.com/popul9/java-dark-theme/blob/main/example.png)
...
- **IntelliJ Dark Theme-inspired colors** — Classic dark background with soft, eye-friendly syntax highlighting
